...
class MRPCTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'mrpc',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'MRPC'))
...
class COLATaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'cola',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'COLA'))
...
class SST2TaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'sst2',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'SST-2'))
...
class STSBTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'stsb',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'STS-B'))
...
class QQPTaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'qqp',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'QQP'))
...
class MNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'mnli',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'MNLI'))
...
class QNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'qnli',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'QNLI'))
    def preprocessor(self, example, add_prefix=True):
...
class RTETaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'rte',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'RTE'))
...
class WNLITaskDataset(AbstractTaskDataset):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(os.path.join(base_dir, 'glue.py'), 'wnli',
                                     split=split, script_version="master",cache_dir=os.path.join(base_dir, 'WNLI'))
