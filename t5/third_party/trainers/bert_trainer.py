...
from MPOE.third_party.trainers.trainer import Trainer
...
from MPOE.utils import use_task_specific_params, reset_config
from MPOE.data import MultiTaskBatchSampler
...
class T5Trainer(Trainer):
    def __init__(self, config=None, data_args=None, dataset_sizes=None, adapter_config=None,
        ...
        if self.args.label_smoothing == 0:
            ...
            from MPOE.third_party.utils import label_smoothed_nll_loss
    ...
    def evaluate(self, eval_datasets: Optional[Dict[str, Dataset]] = None) -> Dict[str, float]:
        ...
        for eval_task, eval_dataset in eval_datasets.items():
            ...
            tasks_metric = {k + "_" + eval_task: v for k, v in output.metrics.items()}
