...
from MPOE.adapters import ADAPTER_CONFIG_MAPPING
...
class Seq2SeqTrainingArguments(TrainingArguments):
    ...
    split_validation_test: Optional[bool] = field(default=False,
                                                  metadata={"help": "If set, for the datasets which do not"
                                                                    ...
                                                                    " datasets)."})
    print_num_parameters: Optional[str] = field(default=True,
                                                metadata={
...
class CustomArguments:
    ...
    output_sub_dir : str = field(default='')
    load_experiment : str = field(default='')
    num_experts : int = field(default=0)
    moe_type : str = field(default='')
    is_scale_prob : bool = field(default=False,
                                metadata={"help":"is_scale_prob"})
    capacity_factor : float = field(default=1.0)
    train_AT_index: str = field(default="2",
                                metadata={"help" : "num of AT index, e.g. 2AT = 1,2,3, 4AT = 2"})
    switch_dropout : float = field(default=0.0)
    gradient_checkpointing : int = field(default=1, metadata={"help":"Set gradient_checkpointing for training args"})
    tasks : str = field(default='')
    eval_tasks : str = field(default='cola,')
